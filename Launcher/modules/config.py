...
def ConfigCreate():
    ...
    config['Java'] = {'Arguments': "-Xms3G -Xmx3G -Xmn1G -XX:+UnlockExperimentalVMOptions -XX:+UseG1GC -XX:G1NewSizePercent=20 -XX:G1ReservePercent=20 -XX:MaxGCPauseMillis=50 -XX:G1HeapRegionSize=32M",
                      '1.7 Java': ".minecraft_files\\runtime\\java-runtime-beta\\windows-x64\\java-runtime-beta\\bin\\javaw.exe",
                      '1.8 Java': ".minecraft_files\\runtime\\java-runtime-beta\\windows-x64\\java-runtime-beta\\bin\\javaw.exe",
                      '1.12 Java': ".minecraft_files\\runtime\\java-runtime-beta\\windows-x64\\java-runtime-beta\\bin\\javaw.exe",
                      '1.16 Java': ".minecraft_files\\runtime\\java-runtime-beta\\windows-x64\\java-runtime-beta\\bin\\javaw.exe",
                      '1.17 Java': ".minecraft_files\\runtime\\java-runtime-beta\\windows-x64\\java-runtime-beta\\bin\\javaw.exe",
                      '1.18 Java': ".minecraft_files\\runtime\\java-runtime-beta\\windows-x64\\java-runtime-beta\\bin\\javaw.exe",
                      }
